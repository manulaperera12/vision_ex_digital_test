...
import '../search_and_category_1/presentation/search_and_category_1_screen.dart';
                  ...
                  Column(
                    children: [
                      ...
                      Padding(padding: EdgeInsets.symmetric(horizontal: 20.0.w), child: CustomButton(text: 'Create an account', onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => SearchAndCategory1ScreenWrapper(),));
                      })),
